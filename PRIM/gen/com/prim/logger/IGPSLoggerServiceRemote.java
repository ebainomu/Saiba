...
public static abstract class Stub extends android.os.Binder implements com.prim.logger.IGPSLoggerServiceRemote
{
private static final java.lang.String DESCRIPTOR = "com.prim.logger.IGPSLoggerServiceRemote";
...
/**
 * Cast an IBinder object into an com.prim.logger.IGPSLoggerServiceRemote interface,
 * generating a proxy if needed.
 */
public static com.prim.logger.IGPSLoggerServiceRemote asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
android.os.IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
if (((iin!=null)&&(iin instanceof com.prim.logger.IGPSLoggerServiceRemote))) {
return ((com.prim.logger.IGPSLoggerServiceRemote)iin);
}
return new com.prim.logger.IGPSLoggerServiceRemote.Stub.Proxy(obj);
}
...
private static class Proxy implements com.prim.logger.IGPSLoggerServiceRemote
{

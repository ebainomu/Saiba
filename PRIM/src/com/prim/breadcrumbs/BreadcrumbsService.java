...
public class BreadcrumbsService extends Service implements Observer, ProgressListener
{
   ...
   public static final String NOTIFY_DATA_SET_CHANGED = "dev.baalmart.prim.intent.action.NOTIFY_DATA_SET_CHANGED";
   public static final String NOTIFY_PROGRESS_CHANGED = "dev.baalmart.prim.intent.action.NOTIFY_PROGRESS_CHANGED";

...
/**
 * An asynchronous task that can even communicates with Twitter to retrieve a request
 * token. (OAuthGetRequestToken) After receiving the request token from Twitter,
 * pop a browser to the user to authorize the Request Token.
 * (OAuthAuthorizeToken)
 */
public class UploadBreadcrumbsLabelTask extends GpxCreator
{
   ...
   protected Uri doInBackground(Void... params)
   {
      ...
      Uri metadataUri = Uri.withAppendedPath(mLabelUri, "metadata");
      Cursor cursor = null;
      try
      {

...
import com.prim.actions.DescribeRoute;
...
public class LabelList extends ListActivity implements ProgressListener
{
            ...
            mImportAction = new Runnable()
               {
                  ...
                  public void run()
                  {
                     mService.startDownloadTask(LabelList.this, LabelList.this, track);
                  }
               };
   ...
   protected Dialog onCreateDialog(int id)
   {
      ...
      switch (id)
      {
         case DIALOG_RENAME:
            ...
            return dialog;
         case DIALOG_DELETE:
            builder = new AlertDialog.Builder(LabelList.this).setTitle(R.string.dialog_delete_title).setIcon(android.R.drawable.ic_dialog_alert).setNegativeButton(android.R.string.cancel, null)
            ...
            return dialog;
         case DIALOG_VACUUM:
            builder = new AlertDialog.Builder(LabelList.this).setTitle(R.string.dialog_vacuum_title).setMessage(R.string.dialog_vacuum_message).setIcon(android.R.drawable.ic_dialog_alert)
                  .setNegativeButton(android.R.string.cancel, null).setPositiveButton(android.R.string.ok, mVacuumOnClickListener);
            dialog = builder.create();
            return dialog;
         case DIALOG_IMPORT:
            builder = new AlertDialog.Builder(LabelList.this).setTitle(R.string.dialog_import_title).setMessage(getString(R.string.dialog_import_message, mImportTrackName))
   ...
   protected void onActivityResult(int requestCode, int resultCode, Intent data)
   {
      if (resultCode != RESULT_CANCELED)
      {
         ...
         {
            case PICKER_OI:
               new GpxParser(LabelList.this, LabelList.this).execute(data.getData());
               break;
            case DESCRIBE:
               ...
               mService.startUploadTask(LabelList.this, mExportListener, trackUri, name);
               break;
            default:
            ...
            mImportAction = new Runnable()
               {
                  ...
                  public void run()
                  {
                     new GpxParser(LabelList.this, LabelList.this).execute(uri);
                  }
               };
            showDialog(DIALOG_IMPORT);
                     ...
                     checkbox.setOnCheckedChangeListener(new OnCheckedChangeListener()
                        {
                           ...
                           public void onCheckedChanged(CompoundButton buttonView, boolean isChecked)
                           {
                              if (isChecked)
                              {
                                 ...
                                 Intent namingIntent = new Intent(LabelList.this, DescribeRoute.class);
                                 ...
                                 mExportListener = new ProgressListener()
                                    {
                                       ...
                                       {
                                          LabelList.this.showError(task, errorMessage, exception);
                                       }
                                    };
   ...
   private OnClickListener mRenameOnClickListener = new DialogInterface.OnClickListener()
      {
         ...
         public void onClick(DialogInterface dialog, int which)
         {
            ...
            LabelList.this.getContentResolver().update(mDialogTrackUri, values, null, null);
         }
      };
   private OnClickListener mVacuumOnClickListener = new DialogInterface.OnClickListener()
      {
         ...
         public void onClick(DialogInterface dialog, int which)
         {
            DatabaseHelper helper = new DatabaseHelper(LabelList.this);
            helper.vacuum();
         }
      };
